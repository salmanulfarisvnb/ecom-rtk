  ...
  return (
    <div className="w-full p-4 mx-auto md:p-8 xl:p-12">
        ...
        <div className="w-full md:w-3/12">
          ...
          <ul className="p-3 space-y-3 font-medium bg-gray-100 border md:font-normal md:">
            {Categories.map((item, index) => (
              <li
                className="flex items-center pl-2 cursor-pointer group gap-x-2 "
                key={index}
              >
      ...
      <div className="container py-12 mx-auto ">
        <h2 className="text-xl font-bold text-center mb-7">Top Product</h2>
        <div className="grid gap-3 grid-rows-1-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5">
